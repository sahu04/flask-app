...
pipeline {
    ...
    stages {
        ...
        stage('Install Dockle') {
            steps {
                script {
                    sh 'sudo curl -Lo dockle https://github.com/goodwithtech/dockle/releases/download/v0.4.13/dockle-Linux-64bit.tar.gz'
                    sh 'sudo tar -xzf dockle-Linux-64bit.tar.gz'
